...
public interface ApiService {
    ...
    @POST()
    @FormUrlEncoded
    Observable<BaseResponse> postFormHttpRequest(@Url String url, @FieldMap HashMap<String,String> paramMaps);
     ...
     */
    @POST()
    Observable<ResponseBody> postJsonHttpRequest(@Url String url, @Body RequestBody jsonBody);
