...
public class PullToRefreshLayout2 extends LinearLayout {
    ...
    private class AutoRefreshAndLoadTask extends
        ...
        protected void onPostExecute(String result) {
            ...
            // 刷新操作
            if (mListener != null)
                mListener.onRefresh(PullToRefreshLayout2.this);
            hide();
        }
    ...
    public interface OnRefreshListener {
         ...
         * 刷新操作
         */
        void onRefresh(PullToRefreshLayout2 pullToRefreshLayout);

        /**
         * 加载操作
         */
        void onLoadMore(PullToRefreshLayout2 pullToRefreshLayout);
    }
