...
public class MyAdapter extends PicAdapter<String> {
	...
	public void convert(final ViewHolder helper, final String item) {
		helper.setImageResource(R.id.id_item_image, R.mipmap.pickimg_pictures_no);
		helper.setImageResource(R.id.id_item_select,
				R.mipmap.pickimg_picture_unselected);
		...
		mImageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mSelectedImage.contains(mDirPath + "/" + item)) {
					...
					mSelect.setImageResource(R.mipmap.pickimg_picture_unselected);
					mImageView.setColorFilter(null);
				} else {
					if (mSelectedImage.size() < maxPic) {
						mSelectedImage.add(mDirPath + "/" + item);
						mSelect.setImageResource(R.mipmap.pickimg_pictures_selected);
