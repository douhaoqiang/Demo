...
import com.dhq.cardswipelibrary.R;
...
public class CardSlideLayout extends ViewGroup {
    ...
    public CardSlideLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CardSlideLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void doBindAdapter() {
        ...
        for (int i = 0; i < VIEW_COUNT; i++) {
            if (i < count) {
                adapter.convertView(adapter.getItem(i), viewList.get(i), i);
            } else {
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            ...
            if (draggableArea == null) {
                ...
                draggableArea = new Rect(left, top, right, bottom);
            }
...
//        changedView.setAlpha(0);
        ...
        if (newIndex < adapter.getCount()) {
            adapter.convertView(adapter.getItem(newIndex), changedView, newIndex);
        } else {
            ...
            public void onChanged() {
                ...
                for (int i = 0; i < VIEW_COUNT; i++) {
                    ...
                    if (i < adapter.getCount()) {
                        ...
                        adapter.convertView(adapter.getItem(isShowing + i), itemView, isShowing + i);
                    } else {
