...
public class CardSwipeActivity2 extends BaseActivity{
    ...
    protected int getLayoutId() {
        return R.layout.activity_card_swipe2;
    }
    ...
    class ViewHolder {
        ...
        public void bindData(CardDataItem itemData) {
            ...
            Glide.with(CardSwipeActivity2.this).load(itemData.imagePath).into(imageView);
