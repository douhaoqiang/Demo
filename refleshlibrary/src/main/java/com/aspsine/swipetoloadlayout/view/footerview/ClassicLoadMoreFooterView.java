package com.aspsine.swipetoloadlayout.view.footerview;
...
public class ClassicLoadMoreFooterView extends SwipeLoadMoreFooterLayout {
    ...
    public void onMove(int y, boolean isComplete, boolean automatic) {
        if (!isComplete) {
            ...
            if (-y >= mFooterHeight) {
                tvLoadMore.setText(getResources().getString(R.string.release_to_load_more));
            } else {
                tvLoadMore.setText(getResources().getString(R.string.swipe_to_load_more));
            }
        }
    }
